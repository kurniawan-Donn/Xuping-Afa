...
<div class="px-6 py-4 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
    <div class="text-sm text-gray-500">
        Menampilkan <span class="font-medium text-gray-900">{{ $products->firstItem() ?? 0 }}</span> - <span class="font-medium text-gray-900">{{ $products->lastItem() ?? 0 }}</span> dari total <span class="font-medium text-gray-900">{{ $products->total() }}</span> produk
    </div>
